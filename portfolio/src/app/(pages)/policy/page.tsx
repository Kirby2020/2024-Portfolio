      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Kirby2019's Portfolio.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kirby2019's Portfolio, accessible
            from{" "}
            <a
              href="https://kirby2019-portfolio.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://kirby2019-portfolio.vercel.app
            </a>
          </p>
        </li>
        <li>
